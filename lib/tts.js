...
const TEXTOS_EVENTO = {
    ...
    linea_correcta: { es: "¡La Línea es correcta! Seguimos para Bingo.", it: "La cinquina è corretta! Continuiamo per il Bingo." },
    bingo_correcto: { es: "¡El Bingo es correcto! Finaliza la partida.", it: "Il Bingo è corretto! Finisce la partita." },
